 ...
 */
final class Version20221011085217 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE tire (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, brand_name VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL)');
        ...
        $this->addSql('CREATE TABLE voiture (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, vehicle_security_id INTEGER DEFAULT NULL, vehicle_model_id INTEGER DEFAULT NULL, plate VARCHAR(10) NOT NULL, mileage INTEGER NOT NULL, price DOUBLE PRECISION DEFAULT NULL, description CLOB DEFAULT NULL, manu_date DATETIME NOT NULL, CONSTRAINT FK_E9E2810FE3853F62 FOREIGN KEY (vehicle_security_id) REFERENCES vehicle_security (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_E9E2810FA467B873 FOREIGN KEY (vehicle_model_id) REFERENCES vehicle_model (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
